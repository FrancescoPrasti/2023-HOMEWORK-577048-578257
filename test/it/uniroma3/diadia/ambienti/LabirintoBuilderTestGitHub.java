...
public class LabirintoBuilderTestGitHub {
	...
	public void testMonolocaleConAttrezzoSingoloDuplicato() {
		Labirinto monolocale = labirintoBuilder
				...
				.addAttrezzo("spada",1)
				.getLabirinto();
		int size = monolocale.getStanzaIniziale().getListaAttrezzi().size();
		assertTrue(size==1);
		assertEquals(Arrays.asList(new Attrezzo("spada",1)),monolocale.getStanzaIniziale().getListaAttrezzi());
	}
	...
	public void testAggiuntaAttrezziAStanze_AppenaAggiunte() {
		...
		labirintoBuilder
				...
				.addAttrezzo(nomeAttrezzo, peso)
				.getLabirinto();
		assertTrue(this.labirintoBuilder.getListaStanze().get(nomeStanza).getListaAttrezzi().contains(new Attrezzo (nomeAttrezzo,peso)));
	...
	public void testAggiuntaAttrezzoAStanze_AppenaAggiunteMultiple() {
		...
		this.labirintoBuilder
				...
				.getLabirinto();
		Attrezzo attrezzo = new Attrezzo(nomeAttrezzo,peso);
		List<Attrezzo> attrezzi = labirintoBuilder.getListaStanze().get(nomeStanza).getListaAttrezzi();
	...
	public void testLabirintoConStanzaBloccata_SenzaPassepartout() {
		...
		//Asserisce che in caso di mancanza di passepartout, invocando il metodo getStanzaAdiacente(), la stanza bloccata ritorna se stessa
	...
	public void testLabirintoCompletoConTutteLeStanze() {
		...
		assertEquals(Arrays.asList(a1,a2),corridoio.getListaAttrezzi());
	}
}