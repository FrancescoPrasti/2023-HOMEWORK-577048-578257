...
public class CaricatoreLabirintoTest {
	...
	public void testMonolocale() throws FormatoFileNonValidoException, FileNotFoundException {
		cl = new CaricatoreLabirinto(new StringReader(monolocale), new LabirintoBuilder(monolocale));
		cl.carica();
	...
	public void testBilocale() throws FormatoFileNonValidoException, FileNotFoundException {
		cl = new CaricatoreLabirinto(new StringReader(bilocale), new LabirintoBuilder(bilocale));
		cl.carica();
